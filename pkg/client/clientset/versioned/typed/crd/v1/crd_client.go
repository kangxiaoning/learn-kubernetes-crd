...
import (
	...
	"github.com/kangxiaoning/learn-kubernetes-crd/pkg/client/clientset/versioned/scheme"
...
// CrdV1Client is used to interact with features provided by the crd.alpha.io group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Machines(namespace string) MachineInterface {
