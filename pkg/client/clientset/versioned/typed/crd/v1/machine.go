...
import (
	...
	scheme "github.com/kangxiaoning/learn-kubernetes-crd/pkg/client/clientset/versioned/scheme"
...
func newMachines(c *CrdV1Client, namespace string) *machines {
	return &machines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *machines) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) List(ctx context.Context, opts metav1.ListOptions) (result *v1.MachineList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.MachineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machines) Create(ctx context.Context, machine *v1.Machine, opts metav1.CreateOptions) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Update(ctx context.Context, machine *v1.Machine, opts metav1.UpdateOptions) (result *v1.Machine, err error) {
	result = &v1.Machine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machines").
...
func (c *machines) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *machines) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *machines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Machine, err error) {
	result = &v1.Machine{}
